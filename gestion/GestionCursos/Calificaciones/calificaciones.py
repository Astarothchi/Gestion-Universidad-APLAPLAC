...
def cargar_datos():
    ...
    try:
        with open(DATA_FILE, 'r') as file:
            ...
            # Convertir arrays de calificaciones a numpy arrays
...
estudiantes = []
cursos = ["Matematica", "Ingles", "Ciberseguridad", "Modelamiento de datos", "Lenguaje de programacion"]  # Cursos disponibles
                        ...
                        while True:
                            try:
                                ...
                                if 1.0 <= calificacion <= 7.0:
                                    ...
                                    guardar_datos()  # Asegúrate de tener definida esta función
